...
class DAYATIF_DUKUNGAN_STAKEHOLDER_LIST_CHILD_Serializer(serializers.ModelSerializer):
    ...
    def get_data(self, obj):
        return get_list_data(self, obj, models.DAYATIF_DUKUNGAN_STAKEHOLDER, DAYATIF_DUKUNGAN_STAKEHOLDER_LIST_DATA_Serializer)
...
class DAYATIF_DUKUNGAN_STAKEHOLDER_LIST_Serializer(serializers.ModelSerializer):
    ...
    def get_detail(self, obj):
        return get_list_detail(self, obj, models.DAYATIF_DUKUNGAN_STAKEHOLDER, DAYATIF_DUKUNGAN_STAKEHOLDER_LIST_CHILD_Serializer)