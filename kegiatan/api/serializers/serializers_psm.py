...
class PSM_MONITORING_DAN_EVALUASI_SUPERVISI_PESERTA_Serializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'parent', 'nama_peserta', 'jenis_kelamin', 'jabatan']
...
class PSM_MONITORING_DAN_EVALUASI_SUPERVISI_DATA_Serializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        exclude = []
        datatables_always_serialize = ['id', 'satker', 'jumlah_kegiatan', 'tanggal_awal', 'tanggal_akhir', 'nama_lingkungan', 'status_indeks', 'nilai_ikp', 'status_ikp', 'deskripsi_hasil', 'simpulan', 'tindak_lanjut', 'dokumentasi', 'pegawai']
