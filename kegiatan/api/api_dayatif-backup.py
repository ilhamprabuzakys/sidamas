...
class DAYATIF_BINAAN_TEKNIS_ViewSet(viewsets.ModelViewSet):
    ...
    def get_flat_values(self, request):
        ...
        # if satker.level == 1:
        #     data = data.filter(satker_id=satker, satker__level=satker.level)
        # elif satker.level == 0:
        #     data = data.filter(satker__provinsi_id=satker.provinsi_id, satker__level=satker.level, status__gt=0)
        # elif satker.level == 2:
    ...
    def export_data(self, request):
        ...
        return Response({
            ...
            'filter_rentang_waktu': filter_rentang_waktu
        })
...
#     @action(detail=False, url_path='bnnk')
