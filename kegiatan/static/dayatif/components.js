...
const GenericFilter = {
    ...
    template: `
        <div class="btn-group dropstart d-none me-2">
...
const ActionBTN = {
    ...
    template: `
        <div v-if="!isDataBNNKdiBNNP" class="list-button gx-3 text-uppercase">
        ...
        <div class="fade-in-text-0 cursor-pointer text-center">Data sudah <b>dikirimkan</b> ke <b>PUSAT</b></div>
    `,
};
...
const ExportBTN = {
    ...
    setup(props) {
        ...
        const handleExport = () => {
            ...
            for (let C = range.s.c; C < range.e.c - 1; ++C) { // Mengubah kondisi perulangan
...
const ItemDokumentasi = {
    ...
    template: `
        <div class="text-center">
            <a :href="url" class="badge bg-primary text-white cursor-pointer" target="_blank">
