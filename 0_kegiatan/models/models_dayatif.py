...
#     def __str__(self):
#         return f'DAYATIF BINAAN TEKNIS - {self.satker.nama_satker}'

# class DAYATIF_BINAAN_TEKNIS(models.Model):
#     # parent = models.ForeignKey(DAYATIF_BINAAN_TEKNIS, on_delete=models.CASCADE, related_name='dayatif_binaan_teknis')
