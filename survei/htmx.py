...
class HTMXtbl_responden_surveiListView(generic.ListView):
...
class HTMXtbl_responden_surveiCreateView(generic.CreateView):
    model = models.tbl_responden_survei
    form_class = forms.tbl_responden_surveiForm
...
class HTMXtbl_responden_surveiDeleteView(generic.DeleteView):
    model = models.tbl_responden_survei
    success_url = reverse_lazy("survei_tbl_responden_survei_htmx_list")
...
class HTMXtbl_surveiListView(generic.ListView):
...
class HTMXtbl_surveiCreateView(generic.CreateView):
    model = models.tbl_survei
    form_class = forms.tbl_surveiForm
...
class HTMXtbl_surveiDeleteView(generic.DeleteView):
    model = models.tbl_survei
    success_url = reverse_lazy("survei_tbl_survei_htmx_list")
