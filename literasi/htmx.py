...
class HTMXLiterasiListView(generic.ListView):
...
class HTMXLiterasiCreateView(generic.CreateView):
    model = models.Literasi
    form_class = forms.LiterasiForm
...
class HTMXLiterasiDeleteView(generic.DeleteView):
    model = models.Literasi
    success_url = reverse_lazy("Literasi_Literasi_htmx_list")
